const charNames = [
  ...
  { key: 74, src: require("./sora.png"), name: "Sora" },
  { key: 75, src: require("./steve.png"), name: "Steve" },
  { key: 76, src: require("./terry.png"), name: "Terry" },
  { key: 77, src: require("./toon_link.png"), name: "Toon Link" },
  { key: 78, src: require("./villager.png"), name: "Villager" },
  { key: 79, src: require("./wario.png"), name: "Wario" },
  {
    key: 80,
    src: require("./wii_fit_trainer.png"),
    name: "Wii Fit Trainer",
  },
  { key: 81, src: require("./wolf.png"), name: "Wolf" },
  { key: 82, src: require("./yoshi.png"), name: "Yoshi" },
  { key: 83, src: require("./young_link.png"), name: "Young Link" },
  { key: 84, src: require("./zelda.png"), name: "Zelda" },
  {
    key: 85,
